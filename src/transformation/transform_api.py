...
def transformer_classement(data):
    try:
        ...
        print(f"Erreur transformation classement : {e}")
        return pd.DataFrame()
...
def transformer_matchs(data):
    try:
        ...
        print(f"Erreur transformation matchs : {e}")
        return pd.DataFrame()
...
def transformer_equipes(data):
    try:
        ...
        print(f"Erreur transformation équipes : {e}")
        return pd.DataFrame()
...
def transformer_buteurs(data):
    try:
        ...
        print(f"Erreur transformation buteurs : {e}")
        return pd.DataFrame()
